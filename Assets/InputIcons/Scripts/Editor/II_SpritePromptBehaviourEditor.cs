...
namespace InputIcons
{
    ...
    public class II_SpritePromptBehaviourEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox("This component is deprecated as of Input Icons version 3.0.0. Consider using the more feature rich II_SpritePrompt instead.", MessageType.Warning);
