...
{
    [CustomEditor(typeof(II_LocalMultiplayerTextPrompt))]
    public class II_LocalMultiplayerTextPromptEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            II_LocalMultiplayerTextPrompt textPromptBehaviour = (II_LocalMultiplayerTextPrompt)target;
