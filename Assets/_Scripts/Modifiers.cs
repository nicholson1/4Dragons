...
public enum Descriptors
{
    ...
    BloodSpells = 9,
    ShadowSpells = 10,
    DecreasedDaggerPower = 11,
    DecreasedShieldPower = 12,
    DecreasedSwordPower = 13,
    DecreasedAxePower = 14,
    DecreasedHammerPower = 15,
    DecreasedNaturePower = 16,
    DecreasedFirePower = 17,
    DecreasedIcePower = 18,
    DecreasedBloodPower = 19,
    DecreasedShadowPower = 20,
    IncreasedDaggerPower = 21,
    IncreasedShieldPower = 22,
    IncreasedSwordPower = 23,
    IncreasedAxePower = 24,
    IncreasedHammerPower = 25,
    IncreasedNaturePower = 26,
    IncreasedFirePower = 27,
    IncreasedIcePower = 28,
    IncreasedBloodPower = 29,
    IncreasedShadowPower = 30,
    IncreasedSpellPower = 31,
    IncreasedPhysicalPower = 32,
    DecreasedSpellPower = 33,
    DecreasedPhysicalPower = 34,
    OnlySpecialStats = 35,
    BattleWithTheElements = 36,
    // NoDaggerStats = 31,
    // NoShieldStats = 32,
    // NoSwordStats = 33,
    // NoAxeStats = 34,
