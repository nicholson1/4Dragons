...
//dragon relics
    ...
    private String[] RelicDescription =
    {
        ...
        "Every time you cast a spell this fight, increase your Spellpower by 2% for the rest of this combat",
        "If you have 4 unique spell schools, gain Spellpower",
        "Every time you use a physical attack this fight, increase your Strength by 2% for the rest of this combat",
        "When you drop below 50% health, gain Armor and MR for the rest of combat",
        "When you drop below 50% health, gain Spellpower and Strength for the rest of this combat",
        "When you drop below 50% health, gain Block",
        ...
        "When you crit, increase your max health by 1",
        "Retain unused block",
        "Elites start combat already damaged",
        ...
        "The first time you die, resurrect with 50% health and become invulnerable",
        "Your first Buff spell each combat costs no energy",
        "? nodes wont have combats",
        "After combat, gain 5% interest on your gold",
        "You can ignore paths on the map (but you can't go backwards)",
        "Buffs and debuffs you cast last 1 turn longer",
        "Spells do double damage to enemy's block",
        "Crits on chilled targets do 100% more Damage",
        "Enemies can not crit against you",
        "Crits do 33% more damage",
        "Physical attacks do double damage to enemy's block",
        "Enemies drop 25% more gold",
        //dragon relics
        "Add 50% of your gold as extra damage to your physical abilities",
        "Heal for half the unblocked damage you deal",
        "Shop's reroll cost no longer increases",
        ...
        "Gain +1 energy, but you can only select 1 loot",
        "Gain +1 energy, but opponents get Strength and Spellpower",
        "Gain +2 energy, but you cannot use 1 cost abilities",
        "Gain +2 energy, but you cannot gain gold",
        "Gain +2 energy, but you cannot see enemy intents",
        "Gain +2 energy, but your opponents go first",
